...
server.listen(PORT, async () => {
    ...
    await page.addInitScript(() => {
        ...
        // Mock fetch locally to simulate taken subdomain
    ...
    // Type a subdomain that will trigger the mocked "taken" response
    await page.fill('#subdomain', 'taken-subdomain');

    // Wait for the "✘ Not available" message to appear
    await page.waitForTimeout(2000); // give debounce and fetch time to complete

    console.log('Taking screenshot of taken subdomain state');
    await page.screenshot({ path: 'deploy_taken_state.png', fullPage: true });
