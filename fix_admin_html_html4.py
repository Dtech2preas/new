...
# Let's put it right after <div id="users-section" class="form-section hidden">
content = content.replace('<div id="users-section" class="form-section hidden">', f'<div id="users-section" class="form-section hidden">\n{analytics_html}')
