...
# Let's put it right after <div id="users" class="tab-content" style="display: none;">
content = content.replace('<div id="users" class="tab-content" style="display: none;">', f'<div id="users" class="tab-content" style="display: none;">\n{analytics_html}')
