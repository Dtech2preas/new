...
# Replace title
content = content.replace("<title>Dashboard | D-TECH Hub</title>", "<title>Profile | D-TECH Hub</title>")

# Make Nav active state correct
content = content.replace('class="nav-link active" onclick="location.href=\'dashboard.html\'"', 'class="nav-link" onclick="location.href=\'dashboard.html\'"')
content = content.replace('class="nav-link" onclick="location.href=\'profile.html\'"', 'class="nav-link active" onclick="location.href=\'profile.html\'"')

# Header replace
content = content.replace('<h1 class="text-2xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-100 to-gray-400">Dashboard</h1>', '<h1 class="text-2xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-100 to-gray-400">Profile</h1>')


# Extract the main block from previous fix_profile.py
